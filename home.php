...
if(isset($_SESSION["email"]) && isset($_SESSION["name"])){
    if (isset($_GET['login']) && $_GET['login'] == "success" && !isset($_SESSION['success'])){
        echo ' 
        <div class="container mt-3"><div class="alert alert-primary">
                      This is success on login.
                    </div></div>';
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="authlogin.php">Login</a></li>
                                <li><a href="authregister.php">Register</a></li>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        ...
                        <p class="section-lead">Components that can be used to make something bigger than the header.
                        </p>
